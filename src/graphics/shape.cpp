...
void Shape::init(const std::vector<Eigen::Vector3f> &vertices, const std::vector<Eigen::Vector3i> &triangles, bool do_rand=true)
{
...
void Shape::draw(Shader *shader)
{
    if(m_wireframe && m_tetVao != static_cast<GLuint>(-1)) {
        ...
        shader->setUniform("m", Eigen::Matrix4f(m_modelMatrix));
