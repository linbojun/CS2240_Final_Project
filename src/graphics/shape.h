...
public:
    ...
    void init(const std::vector<Eigen::Vector3f> &vertices, const std::vector<Eigen::Vector3i> &triangles, bool doRand);
...
private:
    ...
    Eigen::Matrix<float, 4, 4, Eigen::DontAlign> m_modelMatrix;
